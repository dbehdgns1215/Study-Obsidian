...
> 
> 만약 company 라는 인덱스가 있을 때, employee의 타입과 department의 타입이 있을 때 서로 독립적일 것이라고 당연하게 생각이 되지만 실제 Lucene에서 처리할 때는
> 
> 같은 name 타입으로 처리가 되기 때문에 같은 Lucene Field를 공유하게 됐음.
> 
> 즉
