...
##### 문자열 활용
![[Pasted image 20250808095133.png]]

#### Node의 삭제
![[Pasted image 20250808100708.png]]

#### 노드의 추가 / 삭제 연습
![[Pasted image 20250808100858.png]]
...
- 일종의 prefix
- `idx` 사용자 정의 속성을 사용해도 문제는 없지만, 표준적인 방법이 아니기에 `data-*` 방식을 권장.
...
## 이벤트 처리 기본
![[Pasted image 20250811140506.png]]

### 마우스 이벤트
![[Pasted image 20250811140519.png]]
