...
4. PE에서 우클릭 imprt -> import -> Existing Projects into Workspace
5. 프로젝트 우클릭 Maven -> update Projects
6. 일단 실행되나 확인
7. web.xml에 error 페이지 등록 미리 해놓아라


 ![[BackendTest_example (2).zip]]![[board4_session_cookie.zip]]
